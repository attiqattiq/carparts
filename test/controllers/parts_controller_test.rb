...
class PartsControllerTest < ActionController::TestCase
  ...
  test "should create part" do
    assert_difference('Part.count') do
      post :create, part: { part_id: @part.part_id, part_name: @part.part_name, part_price: @part.part_price }
    end
  ...
  test "should update part" do
    patch :update, id: @part, part: { part_id: @part.part_id, part_name: @part.part_name, part_price: @part.part_price }
    assert_redirected_to part_path(assigns(:part))
  end
